...
import com.example.aspect_log.exception.DuplicateEmailException;
...
public class CustomerServiceImplWithSpringData implements CustomerService {
    ...
    public Page<Customer> findAll(Pageable pageInfo) throws Exception {
        if (true) throw new Exception("execution(public * com.example.aspect_log.service.CustomerService.*(..))");
